...
class AlertEngine:
 ...
 def recalculate(self,user_id):
  ...
  for data in candidates:
   ...
   if not x:x=Alert(user_id=user_id,tipo=data.tipo,origem=data.origem,referencia_id=data.referencia_id,status='Novo');self.db.add(x);created.append(x);new_critical+=data.prioridade=='Crítica'
