...
def cashflow(page:int=Query(1,ge=1),page_size:int=Query(50,ge=1,le=200),date_from:date|None=None,date_to:date|None=None,categoria:str|None=None,origem:str|None=None,tipo:str|None=None,status:str|None=None,account_id:uuid.UUID|None=None,transaction_type:str|None=None,search:str|None=None,min_value:Decimal|None=None,max_value:Decimal|None=None,user:User=Depends(current_user),db:Session=Depends(get_db)):
