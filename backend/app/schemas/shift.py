...
class ShiftBase(BaseModel):
    contractor_id:uuid.UUID; title:str|None=Field(default=None,max_length=160); type:ShiftType; specialty:str|None=None; hospital_sector:str|None=None; city:str|None=None; state:str|None=Field(default=None,max_length=2); date:date; start_time:time; end_time:time; duration_hours:Decimal|None=Field(default=None,gt=0); gross_value:Decimal=Field(gt=0); estimated_net_value:Decimal|None=Field(default=None,gt=0); status:ShiftStatus='Agendado'; payment_method:str|None=None; expected_payment_date:date|None=None; notes:str|None=Field(default=None,max_length=2000)
