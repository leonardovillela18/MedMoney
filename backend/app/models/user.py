...
class User(TimestampMixin,Base):
    ...
    name: Mapped[str]=mapped_column(String(120)); crm: Mapped[str]=mapped_column(String(30)); crm_uf: Mapped[str]=mapped_column(String(2)); email: Mapped[str]=mapped_column(String(255),unique=True,index=True); password_hash: Mapped[str]=mapped_column(String(255)); cnpj: Mapped[str]=mapped_column(String(18),unique=True); phone: Mapped[str]=mapped_column(String(30)); city: Mapped[str]=mapped_column(String(100)); city_ibge_code:Mapped[str|None]=mapped_column(String(7),index=True);state: Mapped[str]=mapped_column(String(2)); specialty: Mapped[str]=mapped_column(String(100))
